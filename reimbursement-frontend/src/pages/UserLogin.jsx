    ...
    <div className="login-page-container">
      ...
      <div className="login-page">
        ...
        <div className="login-brand-panel user-panel">
          ...
          <ul className="brand-features">
            <li><span className="feature-dot" /> Quick claim submissions</li>
            <li><span className="feature-dot" /> Real-time status tracking</li>
            <li><span className="feature-dot" /> Secure document uploads</li>
            <li><span className="feature-dot" /> Instant email notifications</li>
          </ul>
        </div>
      </div>
      ...
      <div className="login-form-panel">
        <div className="login-form-container">
          ...
          <form className="login-form" onSubmit={handleSubmit} id="user-login-form">
